      ...
      <div className="row">
        <div className="col-md-12 col-md-offset-0">
          <ul className="timeline">
            ...
            <li
              className="timeline-unverted data-aos= aos-init"
              data-aos="zoom-in"
            >
              <div className="timeline-badge">
              ...
              <div className="timeline-panel">
                <div className="timeline-heading">
                  <h3 className="timeline-title">
                    Registration and Pitch Deck <br />
                    Submission Ends:
                  </h3>
                  <strong>15ᵗʰ July 2021</strong>
                  <br />
                </div>
                <div className="timeline-body">
            ...
            >
              ...
              <div className="timeline-panel">
                <div className="timeline-heading">
                  <h3 className="timeline-title">
                    Webinar with Shortlisted Teams:
                  </h3>
                  <strong>19ᵗʰ July 2021</strong>
                </div>
                <div className="timeline-body">
            ...
            <li className="timeline-inverted aos-init" data-aos="zoom-in">
              ...
              <div className="timeline-panel">
                ...
                <div className="timeline-body">
                  <p>
                    The way to get started is to quit talking and begin CODING
                  </p>
                </div>
              </div>
            </li>
